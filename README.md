...
- Requires each player to place exactly one piece; beginning in round 3 and then every two rounds (3, 5, 7, ...), a successful placement triggers a draw of two distinct random cards and the player must play one right away.
